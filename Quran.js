  ...
  return (
    <View style={{marginLeft:20}}>
        <View style={{marginTop:20}}>
            <Text style={{fontSize:18}}>Assalamualaikum</Text>
                ...
                <TouchableOpacity onPress={handlePress}>
                    <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                        <View style={{display:'flex',flexDirection:'row'}}>
                            ...
                            <View style={{marginLeft:20}}>
                                <Text style={{fontSize:28,fontWeight:'bold',color:'#5FACC0'}}>Al-Fatihah</Text>
                                <View style={{display:'flex',flexDirection:'row'}}>
                                    <Text style={{fontWeight:300}}>MECCAN</Text>
                                    <Text style={{marginLeft:20,fontWeight:300}}>7 Verses</Text>
                                </View>
                            </View>
